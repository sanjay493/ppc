...
<h4 class="text-center"> For The Month  Excavation</h4>
...
if(isset($_POST['on_mth_mines'])){
    ...
    $comm = array("ROM","OB","TOTAL");

     $results =on_mth_romob();
     for($i=0; $i<=8; $i++){
       echo '<tr>';
 ...
 ?>
  ...
  <div class="col-lg-6 rake_dist">
<h4 class="text-center"> Till The Month Excavation</h4>
